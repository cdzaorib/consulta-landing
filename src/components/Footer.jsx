    ...
    <footer>
      <div className="wrap">
        <div className="foot-grid">
          <div className="logo"><span className="dot" />Consulta</div>
        ...
        <div className="foot-bottom">
          <span>© 2026 Consulta. Todos os direitos reservados.</span>
          <span>Projeto de redesign — não afiliado à Conclínica</span>
        </div>
      </div>
    </footer>
  );
